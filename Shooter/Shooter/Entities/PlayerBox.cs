...
namespace Shooter.Entities {
    ...
    static class PlayerPos {
        public static Rectangle CalcRectangle(double globalX, double globalY, double playerX, double playerY, int tileSize) {
            return new Rectangle((int)(((globalX + playerX) * tileSize)), (int)(((globalY + playerY) * tileSize)), tileSize, tileSize);
        }
