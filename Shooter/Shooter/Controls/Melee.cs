...
namespace Shooter.Controls {
    class Melee : Weapon {
        ...
        public Melee(ContentManager content, bool au, double spr, int fr, string t, int d, string ammoT, string n, int maxAm, int ammoC, double rlTime) : base(content, au, spr, fr, t, d, ammoT, n, maxAm, ammoC, rlTime, 5, 0, true) { }
