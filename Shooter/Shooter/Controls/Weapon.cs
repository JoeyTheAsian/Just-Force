        ...
        public virtual Projectile Shoot(ContentManager content, Character p, Camera c, int tileSize, Character e) {
            ...
            if (CheckAmmo()) {
                ...
                if (name.Equals("Rifle")) {
                    proj = new Projectile(content, p.Loc.X, p.Loc.Y, p.Direction + GetSpread() * (Math.PI / 180.0), 2, "BulletTwo", true,
                    ...
                    proj = new Projectile(content, p.Loc.X, p.Loc.Y, p.Direction + GetSpread() * (Math.PI / 180.0), 2, "Bullet", true,
